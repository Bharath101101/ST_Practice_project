...
@CucumberOptions(features="C:\\Users\\bhara\\eclipse-workspace\\BDDCucumberPractice\\src\\main\\java\\features\\wikipage.feature",
				 glue= {"steps"},
				...
				// tags = "@test and @regression" // run scnearios having both the tags. but there is no test tag.. so it will not run it
				 ...
				 monochrome=true,
				 tags = "@login" // Now give the tag @register, you will observe before and after hook is executed
